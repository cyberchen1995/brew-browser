...
- **Port icon cascade to Tauri** (parity) — Appcasks→Google favicon into `src-tauri/src/commands/cask_icon_homepage.rs`. NEXT UP.
- **Trending / Snapshots / Services / Activity** panels (placeholders).
